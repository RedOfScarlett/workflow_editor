	...
	registerCustomNodes(app) {
		class RerouteNode {
			...
			static setDefaultTextVisibility(visible) {
				...
				if (visible) {
					localStorage["DCC.RerouteNode.DefaultVisibility"] = "true";
				} else {
					delete localStorage["DCC.RerouteNode.DefaultVisibility"];
				}
			}
		}

		// Load default visibility
		RerouteNode.setDefaultTextVisibility(!!localStorage["DCC.RerouteNode.DefaultVisibility"]);
