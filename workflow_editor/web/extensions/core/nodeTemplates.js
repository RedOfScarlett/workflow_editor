...
const id = "DCC.NodeTemplates";

class ManageTemplates extends DCCDialog {
	constructor() {
		super();
		this.element.classList.add("dcc-manage-templates");
						...
						$el(
							"div",
							{
								...
								style: {
									...
									gap: "5px",
									backgroundColor: "var(--dcc-menu-bg)"
								},
								ondragstart: (e) => {
										...
										$el("input", {
											...
											onchange: (e) => {
												...
												this.saveVisualCue = setTimeout(function () {
													...
													el.style.backgroundColor = 'var(--dcc-input-bg)';
												}, 15);
											},
											onkeypress: (e) => {
												var el = e.target;
